...
class AutoBackend(nn.Module):
    ...
    def warmup(self, imgsz=(1, 3, 640, 640)):
        ...
        if any(warmup_types) and (self.device.type != "cpu" or self.triton):
            # Use a deterministic finite tensor for warmup. torch.empty() can contain arbitrary values and
            # trips non-finite forward diagnostics even though the actual model/weights are healthy.
