...
class Format:
    ...
    def __call__(self, labels):
        ...
        img = labels.pop("img")
        temporal_imgs = labels.pop("temporal_imgs", None)
        temporal_valid = labels.pop("temporal_valid", None)
        prev_img = labels.pop("prev_img", None)
        has_prev = labels.pop("has_prev", None)
        h, w = img.shape[:2]
        cls = labels.pop("cls")
        instances = labels.pop("instances")
